...
map_tile_image = {
    ...
    config.MAP_TILE_ARMOIRE_BAS: pygame.transform.scale(pygame.image.load("imgs/Interieur/Armoirebas.png"), (config.SCALE, config.SCALE)),
    config.MAP_TILE_ARMOIRE_HAUT: pygame.transform.scale(pygame.image.load("imgs/Interieur/Armoirehaut.png"), (config.SCALE, config.SCALE)),
    config.MAP_TILE_BIBLIOTHEQUE: pygame.transform.scale(pygame.image.load("imgs/Interieur/Bibliotheque.png"), (config.SCALE, config.SCALE)),
    config.MAP_TILE_CHAISE_DROITE: pygame.transform.scale(pygame.image.load("imgs/Interieur/Chaise_droite.png"), (config.SCALE, config.SCALE)),
    config.MAP_TILE_CHAISE_GAUCHE: pygame.transform.scale(pygame.image.load("imgs/Interieur/Chaise_gauche.png"), (config.SCALE, config.SCALE)),
    config.MAP_TILE_PLANTE1_BAS: pygame.transform.scale(pygame.image.load("imgs/Interieur/Plante1_bas.png"), (config.SCALE, config.SCALE)),
    config.MAP_TILE_PLANTE1_HAUT: pygame.transform.scale(pygame.image.load("imgs/Interieur/Plante1_haut.png"), (config.SCALE, config.SCALE)),
    config.MAP_TILE_PLANTE2: pygame.transform.scale(pygame.image.load("imgs/Interieur/Plante2.png"), (config.SCALE, config.SCALE)),
    config.MAP_TILE_TABLE1: pygame.transform.scale(pygame.image.load("imgs/Interieur/Table1.png"), (config.SCALE, config.SCALE)),
    config.MAP_TILE_TABLE2_GAUCHE: pygame.transform.scale(pygame.image.load("imgs/Interieur/Table2gauche.png"), (config.SCALE, config.SCALE)),
    config.MAP_TILE_TABLE2_DROIT: pygame.transform.scale(pygame.image.load("imgs/Interieur/Table2droit.png"), (config.SCALE, config.SCALE)),
    ...
    config.MAP_TILE_FAUTEUIL1: pygame.transform.scale(pygame.image.load("imgs/Interieur/fauteuil1.png"), (config.SCALE, config.SCALE)), 
    config.MAP_TILE_FAUTEUIL2: pygame.transform.scale(pygame.image.load("imgs/Interieur/fauteuil2.png"), (config.SCALE, config.SCALE)),
    config.MAP_TILE_FAUTEUIL3: pygame.transform.scale(pygame.image.load("imgs/Interieur/fauteuil3.png"), (config.SCALE, config.SCALE)),
    config.MAP_TILE_FAUTEUIL4: pygame.transform.scale(pygame.image.load("imgs/Interieur/fauteuil4.png"), (config.SCALE, config.SCALE)),
