...
class PNJ20:
    def __init__(self, screen, game, player):
        ...
        self.PNJ = pygame.image.load("imgs/characters/quatre.png").convert_alpha()
    ...
    def render(self):
        ...
        if self.game.PNJ20_parlé == True and self.cut < 11:
            self.cut = 11
    ...
    def render_scene_0(self):
        self._render_dialogue_box_PNJ("Vous pouvez apporter cette bouteille de ç-lait à mon ù-beau-frère ? Vous le trouverez sans doute dans la forêt à attraper des têtards.")

    def render_scene_1(self):
        self._render_dialogue_box_Answer("Gandalf ? Pourquoi elle me tend une bouteille ?")
        
    def render_scene_2(self):
        self._render_dialogue_box_Gandalf("Elle te demande si tu peux amener cette bouteille de ç-lait à son ù-beau-frère, qui est dans la forêt en train d'attraper des têtards.")
        
    def render_scene_3(self):
        self._render_dialogue_box_Answer("La bouteille de ç-lait ? Et son ù-beau-frère ? Avec un 'ù' devant ?")
        
    def render_scene_4(self):
        self._render_dialogue_box_Gandalf("Oui. Le 'ù-' et le 'ç-' ne se traduisent pas dans ta langue, mais je n'ai pas fait d'erreurs.")
        self.game.compris = True
        
    def render_scene_5(self):
        self._render_dialogue_box_Answer("Un 'ù-beau-frère' et un 'ç-lait'. On va pouvoir ajouter cette information au panneau d'affichage. Allons-y.")
        
    def render_scene_6(self):
        self._render_dialogue_box_Gandalf("Et-et la bouteille de lait ?")
        
    def render_scene_7(self):
        self._render_dialogue_box_Answer("Ah oui c'est vrai. On la prend, on trouvera bien son 'ù-beau-frère' en forêt.")
        self.game.beau_frère = True
        self.game.lait = True
        
    def render_scene_8(self):
        self._render_dialogue_box_Answer("")
        self.game.PNJ20_parlé = True
        
    def render_scene_9(self):
        self._render_dialogue_box_Answer_mécontent("Evidemment, je comprend strictement rien. Super. Bon, j'ai plus qu'à aller voir Gandalf. Comme d'habitude...")
    ...
    def render_scene_11(self):
        self._render_dialogue_box_Gandalf("Elle te dit 'Vous avez pu apporter cette bouteille de lait à mon ù-beau-frère ?'")