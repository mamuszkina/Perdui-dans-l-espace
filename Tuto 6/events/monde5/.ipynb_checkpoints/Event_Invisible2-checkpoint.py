...
class Event_Invisible:
    ...
    def render_scene_0(self):
        self._render_dialogue_box("Mais mais je te zut en fait !!")

    def render_scene_1(self):
        self._render_dialogue_box_Answer("Mais... Mais c'est Gandalf !")

    def render_scene_2(self):
        self._render_dialogue_box("Moi aussi tiens ! Même que j'écris ce que je veux comme tu captes rien !")
    ...
    def render_scene_4(self):
        self._render_dialogue_box("Mais laisse-moi passer !")
        
    def render_scene_5(self):
        self._render_dialogue_box("Même pas en rêve ! Vas t'excuser auprès de ma fille !")
        
    def render_scene_6(self):
        self._render_dialogue_box("C'est mort. J'ai pas à m'excuser, elle a qu'à apprendre à parler lol.")
