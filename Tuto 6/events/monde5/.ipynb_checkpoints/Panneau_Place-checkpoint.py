...
class Panneau_Place:
    def __init__(self, screen, game, player):
        ...
        self.boue = pygame.transform.scale(self.boue, (config.SCREEN_WIDTH//1.5, config.SCREEN_HEIGHT//1.5))
        ...
        self.lait = pygame.transform.scale(self.lait, (config.SCREEN_WIDTH//1.5, config.SCREEN_HEIGHT//1.5))
        ...
        self.mari = pygame.transform.scale(self.mari, (config.SCREEN_WIDTH//18, config.SCREEN_HEIGHT//15))
        self.larmes = pygame.image.load("imgs/monde5/larmes.png").convert_alpha()
        self.larmes = pygame.transform.scale(self.larmes, (config.SCREEN_WIDTH//1.5, config.SCREEN_HEIGHT//1.5))
        self.salive = pygame.image.load("imgs/monde5/salive.png").convert_alpha()
        self.salive = pygame.transform.scale(self.salive, (config.SCREEN_WIDTH//1.5, config.SCREEN_HEIGHT//1.5))
        self.corde = pygame.image.load("imgs/monde5/corde.png").convert_alpha()
        self.corde = pygame.transform.scale(self.corde, (config.SCREEN_WIDTH//13, config.SCREEN_HEIGHT//12))
        self.serpent = pygame.image.load("imgs/monde5/serpent.png").convert_alpha()
        self.serpent = pygame.transform.scale(self.serpent, (config.SCREEN_WIDTH//1.5, config.SCREEN_HEIGHT//1.5))
        self.langue = pygame.image.load("imgs/monde5/langue.png").convert_alpha()
        self.langue = pygame.transform.scale(self.langue, (config.SCREEN_WIDTH//1.5, config.SCREEN_HEIGHT//1.5))
    ...
    def render(self):
        ...
        if self.game.boue_finito == True :
            self.screen.blit(self.boue, (50, 10))

        if self.game.croccodile_finito == True :
            self.screen.blit(self.croccodile, (config.SCREEN_WIDTH // 1.8 ,config.SCREEN_HEIGHT // 3.5)) 
        ...
        if self.game.lait_finito == True :
            self.screen.blit(self.lait, (50, 10))
        ...
        if self.game.larmes_finito == True :
            self.screen.blit(self.larmes, (50, 10))

        if self.game.salive_finito == True :
            self.screen.blit(self.salive, (50, 10))

        if self.game.corde_finito == True :
            self.screen.blit(self.corde, (50, 10))

        if self.game.serpent_finito == True :
            self.screen.blit(self.serpent, (50, 10))

        if self.game.langue_finito == True :
            self.screen.blit(self.lanfue, (50, 10))
