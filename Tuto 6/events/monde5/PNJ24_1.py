...
class PNJ24_1:
    ...
    def render_scene_3(self):
        self._render_dialogue_box_Answer_Gandalf("De la ç-boue ? Un jeune ù-homme ? Tu traduis bien là ?")
    ...
    def render_scene_5(self):
        self._render_dialogue_box_Answer_Gandalf("D'accord. Alors on note que le mot 'boue' porte un 'ç' et on verra plus tard ce que ça veut dire. Allons écrire ça sur le panneau d'affichage.")
        self.game.boue = True
