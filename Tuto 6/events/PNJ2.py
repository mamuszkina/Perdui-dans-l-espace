...
class PNJ2:
    ...
    def _render_dialogue_box(self, text):
        dialogue_rect = self.screen.blit(self.dialogPNJ, (config.SCREEN_WIDTH // 2.8, config.SCREEN_HEIGHT // 1.4))      
    ...
    def render_scene_0(self):
        self._render_dialogue_box("Salut Charlie !")

    def render_scene_1(self):
        self._render_dialogue_box("Belle journée hein ? C'est un temps idéal pour une balade !")

    def render_scene_2(self):
        self._render_dialogue_box("Tu as lu l'annonce sur le panneau d'affichage à côté ?")
