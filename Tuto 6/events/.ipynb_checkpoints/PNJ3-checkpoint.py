...
class ProfPickMonsterEvent2:
    ...
    def render_scene_0(self):
        ...
        img = font.render("Je te bloque la route lol", True, config.BLACK)
    ...
    def render_scene_1(self):
        self.screen.blit(self.dialog, (0, 300))
        font = pygame.font.Font('fonts/PokemonGb.ttf', 20)
        img = font.render("Dégage", True, config.BLACK)
        self.screen.blit(img, (40, 400))
        pass
    ...
    def render_scene_2(self):
        self.screen.blit(self.dialog, (0, 300))
        font = pygame.font.Font('fonts/PokemonGb.ttf', 20)
        img = font.render("Stp merci", True, config.BLACK)
        self.screen.blit(img, (40, 400))
        pass
