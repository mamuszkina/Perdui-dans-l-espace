...
class TV:
    def __init__(self, screen, game, player):
        ...
        self.game = game
        self.player = player
        self.prof_image= pygame.image.load("imgs/TV.png")                        #Pas utile à priori
    ...
    def render_scene_0(self):
        self._render_dialogue_box("La panne mondiale de réseau internet et téléphone continue pour la 13eme semaine consécutive. Les réseaux de télécommunication se disent inquiets de ne voir aucune résolution majeure...")
