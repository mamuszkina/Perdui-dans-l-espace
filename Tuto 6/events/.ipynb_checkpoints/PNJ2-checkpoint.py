...
class ProfPickMonsterEvent:
    ...
    def render_scene_0(self):
        ...
        img = font.render("Bonjour Charlie !", True, config.BLACK)
    ...
    def render_scene_1(self):
        self.screen.blit(self.dialog, (0, 300))
        font = pygame.font.Font('fonts/PokemonGb.ttf', 20)
        img = font.render("Vous venez acheter votre pain et votre éclair au chocolat, comme d’habitude ?", True, config.BLACK)
        self.screen.blit(img, (40, 400))
        pass
    ...
    def render_scene_2(self):
        self.screen.blit(self.dialog, (0, 300))
        font = pygame.font.Font('fonts/PokemonGb.ttf', 20)
        img = font.render("Attendez, je vous prépare ça", True, config.BLACK)
        self.screen.blit(img, (40, 400))
        pass
