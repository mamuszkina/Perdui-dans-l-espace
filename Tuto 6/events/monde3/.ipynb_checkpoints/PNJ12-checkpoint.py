...
class PNJ12:
    def __init__(self, screen, game, player):
        ...
        self.choices = ["0"]
        self.choices1 = ["copaines", "copains", "copini"]
...
#SCENE ZERO, UN ET DEUX
    def render_scene_0(self):
        self._render_dialogue_box_Answer("Cet enfant joue tranquillement. Il n'a pas l'air très disposé à me parler...")
