...
#NE PAS OUBLIER DE CHANGER LE NOMBRE DE MAX CUTS
    ...
    def render_scene_0(self):
        self._render_dialogue_box("VOUS ETES PERDUË ? LES GENS AUTOUR DE VOUS PARLENT BIZARREMENT ? VOUS VOUS ETES SANS DOUTE RETROUVEË DANS LE MAUVAIS UNIVERS ! DEMANDEZ GANDALF AU LABO, IEL VOUS RAMENERA CHEZ VOUS DES QUE POSSIBLE !")
        self.game.unlock_pokedex_entry(3, "Panneau7")
        self.game.unlock_pokedex_entry(3, "Panneau7.1")
