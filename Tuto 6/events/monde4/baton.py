...
class baton:
    ...
    def render(self):  
        ...
        if self.game.bocal == True and self.cut < 6:
            self.cut = 6
            return
    ...
    def render_goodbye(self):
        self._render_dialogue_box("Vous n'avez pas mis la grenouille avec les bâtons.")
    ...
    def render_scene_0(self):
        self._render_dialogue_box("Ce sont des branches de bois. Mettre la grenouille dessus ?")

    def render_scene_1(self):
        self._render_dialogue_box("")
        
    def render_scene_2(self):
        self._render_dialogue_box("Vous avez posé la grenouille parmi les branches.")
        self.game.bocal = False
        self.game.baton = True
        self.game.herbe = False
    ...
    def render_scene_4(self):
        self._render_dialogue_box("Voulez-vous reprendre la grenouille de l'herbe pour la poser avec les branches de bois ?")

    def render_scene_5(self):
        self._render_dialogue_box("")

    def render_scene_6(self):
        self._render_dialogue_box("Voulez-vous reprendre la grenouille du bocal pour la poser avec les branches de bois ?")

    def render_scene_7(self):
        self._render_dialogue_box("")
        
    def render_scene_8(self):
        self._render_dialogue_box("Ce sont des branches de bois.")