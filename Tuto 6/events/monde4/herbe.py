...
class herbe:
    ...
    def render(self):  
        ...
        if self.game.bocal == True and self.cut < 4:
            self.cut = 4
            return
    ...
    def render_goodbye(self):
        self._render_dialogue_box("Vous n'avez pas mis la grenouille dans le plan d'herbe.")
    ...
    def render_scene_0(self):
        self._render_dialogue_box("C'est un plan d'herbe. Y mettre la grenouille ?")

    def render_scene_1(self):
        self._render_dialogue_box("")
        
    def render_scene_2(self):
        self._render_dialogue_box("Vous avez posé la grenouille dans le plan d'herbe.")
        self.game.bocal = False
        self.game.baton = False
        self.game.herbe = True
    ...
    def render_scene_4(self):
        self._render_dialogue_box("Voulez-vous reprendre la grenouille du bocal pour la poser dans le plan d'herbe ?")

    def render_scene_5(self):
        self._render_dialogue_box("")

    def render_scene_6(self):
        self._render_dialogue_box("Voulez-vous reprendre la grenouille du baton pour la poser dans le plan d'herbe ?")

    def render_scene_7(self):
        self._render_dialogue_box("")
        
    def render_scene_8(self):
        self._render_dialogue_box("C'est un plan d'herbe.")