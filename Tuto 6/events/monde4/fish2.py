...
class fish2:
    ...
    def render_scene_0(self):
        self._render_dialogue_box("CRZZZZZZZZZZZZk CRRRRRRRRR ZZZZZZZZKKKK")

    def render_scene_1(self):
        self._render_dialogue_box_Answer("Aie ! Mon oreille ! C’est ce satané poisson qui vibre, aie aie !")
        
    def render_scene_2(self):
        self._render_dialogue_box("CRZZZZZZZZZZZZk CRRRRRRRRR ZZZZZZZZKKKK")

    def render_scene_3(self):
        self._render_dialogue_box_Answer("Il doit y avoir des interférences dans ce bâtiment, ça doit le gêner... J’espère qu’il fonctionnera encore !")

    def render_scene_4(self):
        self._render_dialogue_box_Answer("Raaaaah c’était vraiment pas le moment !!!")
        self.game.fish2_done = True