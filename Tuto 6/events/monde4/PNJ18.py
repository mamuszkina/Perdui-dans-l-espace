...
#SCENE ZERO 
    def render_scene_0(self):
        self._render_dialogue_box("Tu étais dehors pendant la tempête hier ? ça soufflait tellement, ça a fait voler beaucoup de poussière INUN !")
        self.game.unlock_pokedex_entry(4, "PNJ18")

    def render_scene_1(self):
        self._render_dialogue_box_Answer("Inun ? Bon, je suis définitivement pas chez moi...")