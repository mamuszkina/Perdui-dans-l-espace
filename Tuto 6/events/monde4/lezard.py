...
class lezard:
    ...
    def render(self):  
        ...
        if self.game.serpent == True and self.cut < 6:
            self.cut = 6
            return
    ...
    def render_goodbye(self):
        self._render_dialogue_box("Vous n'avez pas pris le lézard.")
    ...
    def render_scene_0(self):
        self._render_dialogue_box("Voulez-vous attraper le lézard ?")

    def render_scene_1(self):
        self._render_dialogue_box("")
        
    def render_scene_2(self):
        self._render_dialogue_box("Vous avez pris le lézard.")
        self.game.serpent = False
        self.game.grenouille = False
        self.game.lezard = True
    ...
    def render_scene_4(self):
        self._render_dialogue_box("Voulez-vous reposer la grenouille pour attraper le lézard ?")

    def render_scene_5(self):
        self._render_dialogue_box("")

    def render_scene_6(self):
        self._render_dialogue_box("Voulez-vous reposer le serpent pour attraper le lézard ?")

    def render_scene_7(self):
        self._render_dialogue_box("")

    def render_scene_8(self):
        self._render_dialogue_box("C'est un lézard.")