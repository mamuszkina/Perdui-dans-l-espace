...
class PNJ19:
    ...
    def render_scene_0(self):
        self._render_dialogue_box("Hé, hé, regarde un peu tous les mille-pattes AMOKA que j’ai attrapés ! Je vais bientôt avoir besoin d’un deuxième sceau ANON !")
        self.game.unlock_pokedex_entry(4, "PNJ19")
        self.game.unlock_pokedex_entry(4, "PNJ19.1")
