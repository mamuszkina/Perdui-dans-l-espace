...
class fish:
    def __init__(self, screen, game, player):
        ...
        self.dialogPNJ = pygame.image.load("imgs/paper.png").convert_alpha()
    ...
    def _render_dialogue_box(self, text):
        dialogue_rect = self.screen.blit(self.dialogPNJ, (config.SCREEN_WIDTH // 2.8, config.SCREEN_HEIGHT // 2))       # chiffres = position bulle de dialogue
    ...
    def render_scene_0(self):
        self._render_dialogue_box_Answer("Oh, il y a un touuuut petit poisson par terre. Et une lettre accrochée à sa nageoire :")
