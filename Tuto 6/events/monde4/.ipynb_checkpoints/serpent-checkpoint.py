...
#        self.resolved = False
 ...
 #           self.handle_choice1
    ...
    def render(self):            
        ...
        if self.game.portier4_2dialogue1_done == True and self.cut < 4:
            self.cut = 4
            return
    ...
    def render_scene_1(self):
        self._render_dialogue_box("Bien, alors on va pouvoir commencer.")
        
    def render_scene_2(self):
        self._render_dialogue_box("")

    def render_scene_3(self):
        self._render_dialogue_box_Answer("Il vous reçevra si vous passez la première CRRRRZZZK de l’entretien. Si vous êtes prêt, on va pouvoir commencer.")

    def render_scene_4(self):
        self._render_dialogue_box("Comme votre but est de répondre aux besoins de sa seigneurie, on va tester votre aptitude à répondre CRRRRRR rapidement à ses besoins. Pour commencer, la CRRRRRZZZZK isi de sa seigneurie s’est encore échappée ! Rattapez-là et CZZZZZZRRRRK rapportez-là moi.")
