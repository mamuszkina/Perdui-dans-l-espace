...
#SCENE ZERO 
    def render_scene_0(self):
        self._render_dialogue_box("VOITURE ANON A VENDRE")
        self.game.unlock_pokedex_entry(4, "panneau14")

    def render_scene_1(self):
        self._render_dialogue_box_static("VOITURE ANON A VENDRE")
        self._render_dialogue_box_Answer("Ok, je comprend ce qui est écrit. Mais c'est sans doute à cause mon poisson-traduction... Mais ANON ? C'est quoi ça ?!")
