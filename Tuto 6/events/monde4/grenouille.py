...
class grenouille:
    ...
    def render(self):  
        ...
        if self.game.serpent == True and self.cut < 4:
            self.cut = 4
            return
    ...
    def render_goodbye(self):
        self._render_dialogue_box("Vous n'avez pas pris la grenouille.")
    ...
    def render_scene_0(self):
        self._render_dialogue_box("Voulez-vous attraper la grenouille ?")

    def render_scene_1(self):
        self._render_dialogue_box("")
        
    def render_scene_2(self):
        self._render_dialogue_box("Vous avez pris la grenouille.")
        self.game.serpent = False
        self.game.grenouille = True
        self.game.lezard = False
    ...
    def render_scene_4(self):
        self._render_dialogue_box("Voulez-vous reposer le serpent pour attraper la grenouille ?")

    def render_scene_5(self):
        self._render_dialogue_box("")

    def render_scene_6(self):
        self._render_dialogue_box("Voulez-vous reposer le lézard pour attraper la grenouille ?")

    def render_scene_7(self):
        self._render_dialogue_box("")

    def render_scene_8(self):
        self._render_dialogue_box("C'est une grenouille.")