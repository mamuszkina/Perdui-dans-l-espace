...
#SCENE ZERO 
    def render_scene_0(self):
        self._render_dialogue_box("Ne pas ramasser toute la mousse INUN. Elle est un refuge pour nos amis les larves AMOKA")
        self.game.unlock_pokedex_entry(4, "panneau16")
        self.game.unlock_pokedex_entry(4, "panneau16.1")

    def render_scene_1(self):
        self._render_dialogue_box_static("Ne pas ramasser toute la mousse INUN. Elle est un refuge pour nos amis les larves AMOKA")
        self._render_dialogue_box_Answer("Ok, je comprend ce qui est écrit. Mais c'est sans doute à cause mon poisson-traduction... Mais Inun ? Amoka ? C'est quoi ça ?!")
        self.screen.blit(self.charlie_surpris, (config.SCREEN_WIDTH // 1.6, config.SCREEN_HEIGHT * 0.5))
        
    def render_scene_2(self):
        self._render_dialogue_box_static("Ne pas ramasser toute la mousse INUN. Elle est un refuge pour nos amis les larves AMOKA")
        self._render_dialogue_box_Answer("Je ferais mieux d'aller chercher Gandalf... Encore une fois.")
