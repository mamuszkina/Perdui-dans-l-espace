...
#NE PAS OUBLIER DE CHANGER LE NOMBRE DE MAX CUTS
    ...
    def render(self):
        ...
        if self.game.compris6 == False and self.cut < 4 :
            self.cut = 4

        if self.game.Voiture == True and self.cut < 2 :
            self.cut = 2
    ...
    def render_scene_0(self):
        self._render_dialogue_box_panneau("PIM choubidou-wa to kalaboudi sintala$")

    def render_scene_1(self):
        self._render_dialogue_box("")

    def render_scene_2(self):
        self._render_dialogue_box_panneau("PIM voiture to kalaboudi sintala$")
        self.game.unlock_pokedex_entry(6, "panneau19")
    ...
    def render_scene_5(self):
        self._render_dialogue_box_static("PIM choubidou-wa to kalaboudi sintala$")
        self._render_dialogue_box_penaud("Evidemment. ça m'aurait étonné aussi que j'arrive chez moi. Et allez, je retourne voir Gandalf. Mais cette fois-ci, je sens que c'est la bonne... Enfin. Quand je vais raconter ça, personne ne voudra me croire...")
