...
class Fig_Enfant:
    def __init__(self, screen, game, player):
        ...
        self.figurine = pygame.image.load("imgs/monde6/water.png")
    ...
    def render(self):
        if self.game.portier6 == True and self.cut <2:
            self.cut = 2

        if self.game.Fig_Enfant == True and self.cut <4:
            self.cut = 4
    ...
    def render_scene_0(self):
        ...
        self.screen.blit(self.figurine, (0, 450))
