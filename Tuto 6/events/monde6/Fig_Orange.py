...
class Fig_Orange:
    def __init__(self, screen, game, player):
        ...
        self.figurine = pygame.image.load("imgs/monde6/orange.png").convert_alpha()
    ...
    def render(self):
        if self.game.portier6 == True and self.game.Fig_Orange == False and self.cut <2:
            self.cut = 2

        if self.game.Fig_Orange == True and self.cut == 0:
            self.cut = 4
    ...
    def render_scene_0(self):
        self._render_dialogue_box("C'est une figurine d'orange. Quelqu'un a dû la faire tomber.")
    ...
    def render_scene_2(self):
        ...
        self.screen.blit(self.figurine, (config.SCREEN_WIDTH//4, config.SCREEN_HEIGHT//2))
        self.game.Fig_Orange = True

    def render_scene_3(self):
        self._render_dialogue_box("")

    def render_scene_4(self):
        self._render_dialogue_box("C'est ici que j'ai trouvé la figurine en forme d'orange.")
