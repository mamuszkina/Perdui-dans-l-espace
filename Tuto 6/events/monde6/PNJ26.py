...
class PNJ26:
    ...
    def render(self):
        if self.game.compris6 == True and self.game.Lune == False and self.cut == 0:
            self.cut = 3

        if self.game.Lune == True and self.cut == 0:
            self.cut = 9
    ...
    def _render_dialogue_box_Answer_content(self, text):
        dialogue_rect = self.screen.blit(self.dialog, (config.SCREEN_WIDTH // 2.8, config.SCREEN_HEIGHT // 1.4))      # chiffres = position bulle de dialogue
    ...
    def render_scene_0(self):
        self._render_dialogue_box("Whinni saragra, eu arrasulli PIM waaaaaaaa.")
    ...
    def render_scene_3(self):
        self._render_dialogue_box("PIM waaaaaaaa, atialla ata ?")
        
    def render_scene_4(self):
        self._render_dialogue_box_Answer("Hein ? Qu'est-ce que tu dis ?")
        
    def render_scene_5(self):
        self._render_dialogue_box("PIM waaaaaaaa, PIM waaaaaaaa !")
        
    def render_scene_6(self):
        self._render_dialogue_box_Answer_content("Tu me désigne la lune ? Haaan, 'waaaaaaaa' ça veut dire lune !")

    def render_scene_7(self):
        self._render_dialogue_box("PIM waaaaaaaa, lune !")
        self.game.Lune = True
        self.game.unlock_pokedex_entry(6, "PNJ26")
        self.game.unlock_pokedex_entry(6, "PNJ26.1")

    def render_scene_8(self):
        self._render_dialogue_box("")

    def render_scene_9(self):
        self._render_dialogue_box("Whinni saragra, eu arrasulli PIM lune.")