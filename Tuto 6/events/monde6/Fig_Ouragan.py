...
class Fig_Ouragan:
    def __init__(self, screen, game, player):
        ...
        self.figurine = pygame.image.load("imgs/monde6/ouragan.png").convert_alpha()
        self.figurine = pygame.transform.scale(self.figurine, (config.SCREEN_WIDTH//7, config.SCREEN_HEIGHT//5))
    ...
    def render(self):
        if self.game.portier6 == True and self.game.Fig_Ouragan == False and self.cut <2:
            self.cut = 2

        if self.game.Fig_Ouragan == True and self.cut == 0:
            self.cut = 4
    ...
    def render_scene_0(self):
        self._render_dialogue_box("C'est une figurine en forme d'ouragan.")
    ...
    def render_scene_2(self):
        self._render_dialogue_box("ça doit être une des six figurines du portier, quelqu'un a dû la trouver par terre et la ramener chez lui. Je ferais mieux de la ramasser.")
        self.screen.blit(self.figurine, (config.SCREEN_WIDTH//4, config.SCREEN_HEIGHT//2))
        self.game.Fig_Ouragan = True

    def render_scene_3(self):
        self._render_dialogue_box("")

    def render_scene_4(self):
        self._render_dialogue_box("C'est ici que j'ai trouvé la figurine en forme d'ouragan.")
