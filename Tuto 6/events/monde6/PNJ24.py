...
class PNJ24:
    ...
    def render(self):
        if self.game.compris6 == True and self.game.Enfant == False and self.cut == 0:
            self.cut = 3

        if self.game.Enfant == True and self.cut == 0:
            self.cut = 5
    ...
    def render_scene_0(self):
        self._render_dialogue_box("Bladidouwa baza baza PAM bibou grrrr choubiwah !")
    ...
    def render_scene_5(self):
        self._render_dialogue_box("Bladidouwa baza baza PAM enfant grrrr choubiwah !")
        self.game.unlock_pokedex_entry(6, "PNJ24")