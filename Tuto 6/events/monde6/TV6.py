...
class TV6:
    def __init__(self, screen, game, player):
        ...
        self.choices = ["0"]
        self.choices1 = ["Chaine 1", "Chaine 2", "Eteindre et partir"]
    ...
    def render_scene_0(self):
        self._render_dialogue_box("Mettre quelle chaîne ?")

    def render_scene_1(self):
        self._render_dialogue_box("")
        
    def render_scene_2(self):
        self._render_dialogue_box("C'est une chaîne de météo. Le temps a l'air vraiment très mauvais. Le présentateur n'arrête pas de répéter 'gabidoum' quand je vois une image de tempête... gabidoum ça doit vouloir dire tempête, ou ouragan...")
        self.game.Ouragan = True
        self.game.unlock_pokedex_entry(6, "TV6")
        
    def render_scene_3(self):
        self._render_dialogue_box("")
        
    def render_scene_4(self):
        self._render_dialogue_box("ça doit être une chaine de vente de voiture. Des voitures familiales, des voitures coupé-sport, des voitures d'occasion... Et la voix off qui répète tout le temps 'choubidou-wa'... Choubidou-wa doit être le mot pour voiture.")
        self.game.Voiture = True
        self.game.unlock_pokedex_entry(6, "TV6.1")
