...
#NE PAS OUBLIER DE CHANGER LE NOMBRE DE MAX CUTS
    ...
    def render_scene_0(self):
        self._render_dialogue_box ("Il y a plein de livres dans cette bibliothèque. '12 human en colère', le conte de lu princæ Kaguya', 'Princæ mononoké', 'lu géanx de fer',... ")
        self.game.unlock_pokedex_entry(2, "huit")