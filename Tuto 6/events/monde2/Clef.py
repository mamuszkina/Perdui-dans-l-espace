...
class Clef:
    ...
    def render(self):          
        ...
        if self.game.PNJ7_2_dialogue_done == False and self.cut < 2:
            self.cut = 2
            return
    ...
    def render_scene_0(self):
        self._render_dialogue_box_Answer("Ah ben la voilà cette fichue clef ! C'est pas trop tôt !")

    def render_scene_1(self):
        self._render_dialogue_box_Answer("Je vais enfin pouvoir ouvrir ce satané labo pour rentrer chez moi !")
        self.game.Clef = True

    def render_scene_2(self):
        self._render_dialogue_box_Answer("L'herbe est bien haute par ici...")