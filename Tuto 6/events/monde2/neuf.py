...
#NE PAS OUBLIER DE CHANGER LE NOMBRE DE MAX CUTS
    ...
    def render_scene_0(self):
        self._render_dialogue_box ("Beaucoup de livres ici : 'le cercle des poètes disparux', 'Les trois mousquetaires', Lu seigneurx des anneaux', 'Lu dernaer elfe'...")
        self.game.unlock_pokedex_entry(2, "neuf")