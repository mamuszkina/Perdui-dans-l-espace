...
class Maison_papier:
    def __init__(self, screen, game, player):
        ...
        self.game = game
        self.player = player
        self.prof_image= pygame.image.load("imgs/Table2gauche.png")                        #Pas utile à priori
...
#NE PAS OUBLIER DE CHANGER LE NOMBRE DE MAX CUTS
    ...
    def render_scene_2(self):
        self._render_dialogue_box ("PNJ9 n'avait pas menti, c'est un sacré bordel. Il n'y a pas de clef ici mais un mot :")

    def render_scene_3(self):
        self._render_dialogue_box("coucou voisaine ! Comme t’étais pas là je suis venux te prendre la clef du labo, si jamais t’en as besoin viens la récupérer ! Bisous !")
