...
#NE PAS OUBLIER DE CHANGER LE NOMBRE DE MAX CUTS
    ...
    def render_scene_0(self):
        self._render_dialogue_box("VOUS ETES PERDUS ? LES GENS AUTOUR DE VOUS PARLENT BIZARREMENT ? VOUS VOUS ETES SANS DOUTE RETROUVAE DANS LE MAUVAIS UNIVERS ! DEMANDEZ GANDALF AU LABO AL VOUS RAMENERA CHEZ VOUS DES QUE POSSIBLE !")
