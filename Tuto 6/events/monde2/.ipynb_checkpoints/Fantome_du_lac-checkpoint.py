...
class Fantome_du_lac:
    def __init__(self, screen, game, player):
        ...
        self.game = game
        self.player = player
        self.prof_image= pygame.image.load("imgs/water.png")                        #Pas utile à priori
        self.dialog = pygame.image.load("imgs/dialog.png")
        self.digicode = pygame.image.load("imgs/digicode.png")
        self.touchesdigicode = pygame.image.load("imgs/digicode2.png")
        self.enigme = pygame.image.load("imgs/enigme.png")
        # Son de digicode
        self.digicodeFAUX = pygame.mixer.Sound("sons/digicodefaux.mp3")
        self.digicodeVRAI = pygame.mixer.Sound("sons/digicodevrai.mp3")
    ...
    def _render_dialogue_box_Digicode(self, text):
        digicode = self.screen.blit(self.digicode, (150,20))
        dialogue_rect = self.screen.blit(self.dialog, (0, 450))      # chiffres = position bulle de dialogue
    ...
    def _render_dialogue_box_Enigme(self, text):
        dialogue_rect = self.screen.blit(self.enigme, (180, 65))      # chiffres = position bulle de dialogue

        font = pygame.font.Font("fonts/digicode.ttf", 40)           #20 = taille des lettres
        color = config.WHITE
    ...
    def render_choice(self):
        ...
        dialogue_rect = self.screen.blit(self.touchesdigicode, (190, 280))
        ...
        line_h = font.get_height() + 70  #modifier espacement haut-bas
...
#                )
    ...
    def render_scene_3(self):
        ...
        self._render_dialogue_box_Enigme("__ Rus__, rou__, ru___, ______ sur ___ rosse, ___rose à la main")
    ...
    def render_scene_5(self):
        self._render_dialogue_box_Entrée("")
        self._render_dialogue_box_Enigme("An Rus__, rou__, ru___, ______ sur ___ rosse, ___rose à la main")

    def render_scene_6(self):
        self._render_dialogue_box_Entrée("")
        self._render_dialogue_box_Enigme("An Russe, rou__, ru___, ______ sur ___ rosse, ___rose à la main")

    def render_scene_7(self):
        self._render_dialogue_box_Entrée("")
        self._render_dialogue_box_Enigme("An Russe, rouxe, rus__, ______ sur ___ rosse, ___rose à la main")

    def render_scene_8(self):
        self._render_dialogue_box_Entrée("")
        self._render_dialogue_box_Enigme("An Russe, rouxe, rusae, ______ sur ___ rosse, ___rose à la main")

    def render_scene_9(self):
        self._render_dialogue_box_Entrée("")
        self._render_dialogue_box_Enigme("An Russe, rouxe, rusae, montae sur ___ rosse, ___rose à la main")

    def render_scene_10(self):
        self._render_dialogue_box_Entrée("")
        self._render_dialogue_box_Enigme("An Russe, rouxe, rusae, montae sur une rosse, ___rose à la main")
    ...
    def render_scene_12(self):
        if self.digicodeVRAI_played:
            ...
            self.digicodeVRAI_played = False
        self._render_dialogue_box_Answer("Gandalf, t'as intérêt à pas te planter cette fois !")