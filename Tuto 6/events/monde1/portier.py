...
class portier:
    ...
    def render_scene_2(self):
        self._render_dialogue_box_penaud("Vous êtes prêti ? Bien ! Comment vous nommez la personne chez qui vous achetez du pain ?")

    def render_scene_3(self):
        self._render_dialogue_box_penaud("Bien. Et qu’est-ce que vous lui dites en partant ?")
    ...
    def render_scene_9(self):
        self._render_dialogue_box_penaud("Ah non, désoléi bonhommi. Mais si ça peut t'aider, t'as remarqué que c'est seulement quand le mot donne un indice sur le genre d'une personne qu'il change ?")

    def render_scene_10(self):
        self._render_dialogue_box_penaud("")

    def render_scene_11(self):
        self._render_dialogue_box_penaud("Nooooon... Tu y es presque ! Si tu veux de l'aide, j'ai un traducteur sur mon ordinateur que j'ai laissé à la boulangerie. Mon code c'est 'Blablabla'. Vas voir si tu veux.")
        self.game.code_portier = True