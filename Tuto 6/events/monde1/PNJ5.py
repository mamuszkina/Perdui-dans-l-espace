...
class PNJ5:
    def __init__(self, screen, game, player):
        ...
        self.choices = ["0"]
        self.choices1 = ["Madame ?", "Hé, dites, vous avez vu ça ?"]
        self.choices2 = ["Insister", "Ne pas insister"]
        self.choices3 = ["De quoi ?" , "Euh, oui, oui, je vais aller voir..."]
    ...
    def render_goodbye(self):
        self._render_dialogue_box("... Je comprend pas ce que vous voulez ...")
    ...
    def handle_choice(self):
        ...
        elif choices == "Hé, dites, vous avez vu ça ?":
        ...
        elif choices == "Euh, oui, oui, je vais aller voir...":
            self.choice_active = False
            self.cut = 8
            self.goodbye = False
            self.current_char = 0
    ...
    def render_scene_2(self):
        self._render_dialogue_box(".........Oui............")
        self.screen.blit(self.charlie_surpris_gray, (config.SCREEN_WIDTH // 1.6, config.SCREEN_HEIGHT * 0.5))

    def render_scene_3(self):
        self._render_dialogue_box("Je ne comprend pas ce que vous voulez...")
        self.screen.blit(self.charlie_surpris_gray, (config.SCREEN_WIDTH // 1.6, config.SCREEN_HEIGHT * 0.5))

    def render_scene_4(self):        
        self._render_dialogue_box_Answer("Vous n’avez pas vu cet éclair blanc ? Et ce boom énorme qui a fendu le ciel ?")
        self.screen.blit(self.charlie_surpris, (config.SCREEN_WIDTH // 1.6, config.SCREEN_HEIGHT * 0.5))

    def render_scene_5(self):
        self._render_dialogue_box("Euh non... Mais j’étais dans la lune... Peut-être que quelqu’uni d’autre a vu quelque chose...")
        self.screen.blit(self.charlie_surpris_gray, (config.SCREEN_WIDTH // 1.6, config.SCREEN_HEIGHT * 0.5))
        self.game.unlock_pokedex_entry(1, "PNJ5.1")

    def render_scene_6(self):
        self._render_dialogue_box("Je disais que si ça se trouve, li humaini là-bas a vu ce que vous décrivez...")
        self.screen.blit(self.charlie_surpris_gray, (config.SCREEN_WIDTH // 1.6, config.SCREEN_HEIGHT * 0.5))
        self.game.unlock_pokedex_entry(1, "PNJ5.2")

    def render_scene_7(self):
        self._render_dialogue_box_Answer("Hein, euh, oui, oui, merci...")
