...
#NE PAS OUBLIER DE CHANGER LE NOMBRE DE MAX CUTS
    ...
    def render_scene_0(self):
        self._render_dialogue_box("ON PARLE BIZARRE ? PAS COMME TOUS LES JOURS ? VOUS VOUS ETES SANS DOUTE PERDUI DANS LE MAUVAIS ESPACE-TEMPS. DEMANDEZ GANDALF DE LA SCENE ERRES, AU NORD DE LA VILLE")
        self.game.panneau2_Indice_dialogue_done = True
        self.game.unlock_pokedex_entry(1, "Panneau2")

    def render_scene_1(self):
        self._render_dialogue_box_static("ON PARLE BIZARRE ? PAS COMME TOUS LES JOURS ? VOUS VOUS ETES SANS DOUTE PERDUI DANS LE MAUVAIS ESPACE-TEMPS. DEMANDEZ GANDALF DE LA SCENE ERRES, AU NORD DE LA VILLE")
        self._render_dialogue_box_Answer("Mais qu'est-ce que c'est que cette histoire ?! On marche sur la tête ! Je devrais aller chercher ce Gandalf pour y voir plus clair...")
